...
export default function SignupPage() {
  ...
  // const { login } = useAuth() // Handled by next-auth now
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    // Allows basic 10 digit, with or without +91
    ...
    <div className="min-h-screen bg-gradient-to-b from-primary/5 to-background flex items-center justify-center px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-3">
          ...
          <CardDescription className="text-center">Join thousands managing their health</CardDescription>
        </CardHeader>
        <CardContent>
